...
// Hubert receiver
uint8_t broadcastAddress[] = {0x40, 0xF5, 0x20, 0x44, 0xB3, 0xC4};
...
//UPDATE SERVO POSITIONS
  ...
  Readings.lc3 = lc3;
  Readings.fm  = fm;
  //micmic behavior of checking servo angle
  //for now this just takes the value from the sender. but once we are able to check the servo angle, switch out S1 to servo value
  Readings.S1 = S1;
// send the servo degree back
